        ...
        >
          <div className="relative h-[100%] flex flex-col justify-center items-center  ">
            <div className="relative flex justify-between h-[80%]">
              ...
              <div
                id="things"
                className="flex flex-col absolute z-10 top-1/3 max-[770px]:left-[50%]  md:left-[70%] lg:left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-[750px]:flex max-[750px]:flex-row  max-[750px]:gap-[25px] max-[750px]:top-[-10px] "
              >
