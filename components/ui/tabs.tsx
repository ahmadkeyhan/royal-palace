...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex flex-row-reverse h-10 items-center justify-center font-ravi rounded-md bg-muted p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
