  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleCreateSubmit} className="space-y-4 p-4 border border-slate-200 rounded-lg bg-white">
        <h3 className="font-medium font-doran">
          افزودن کارمند جدید
        </h3>
        <div className="grid gap-4 sm:grid-cols-2 font-ravi">
          <div>
            <Input
        ...
        <div className="flex">
          <Button type="submit" className="font-ravi hover:bg-amber-600">
      ...
      <div className="space-y-2">
        <h3 className="font-medium font-doran text-slate-700">لیست کارمندان</h3>
        {users.length === 0 ? (
                ...
                <CardContent className="p-0">
                  <form onSubmit={handleUpdateSubmit} className="p-4 space-y-4">
                    ...
                    <div className="flex gap-2 font-ravi">
                      ...
                      <Button type="button" variant="default" className="bg-golden_yellow/40" size="sm" onClick={() => setEditingId(null)}>
              ...
              <Card key={user.id} className="overflow-hidden mb-3">
                <CardContent className="p-0">
                  <div className="p-4 flex flex-row-reverse justify-between items-center">
                    <div>
                      <h3 className="font-medium font-ravi">{user.name}</h3>
                    </div>
