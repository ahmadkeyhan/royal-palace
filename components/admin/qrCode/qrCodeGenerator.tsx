      ...
      <Card>
        <CardContent className="pt-6 flex flex-col items-center">
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            <Button onClick={handleDownloadPNG} variant="outline" className="text-sm font-ravi text-text_royal_green bg-golden_yellow gap-2">
              <Download className="w-4 h-4" />
              <p>دانلود PNG</p>
            </Button>
            <Button onClick={handleDownloadSVG} variant="outline" className="text-sm font-ravi text-text_royal_green bg-golden_yellow gap-2">
              <Download className="w-4 h-4" />
              <p>دانلود SVG</p>
            </Button>
          </div>
